    ...
    $(document).ready(function () {
        ...
        if ($('#quarterfinal').length > 0) {
            ...
            $('#quarterfinal').teamStandings({
                teams: [
                    //['<span ><img src="../images/soccer/petrolandia.png" width="30" height="30" alt="team-logo"></span> <span>Petrolandia</span>', '<span ><img src="../images/soccer/linderpool.png" width="30" height="30" alt="team-logo"></span> <span>Lindeia</span>'],
                    //['<span ><img src="../images/soccer/brasilindustrial.png" width="30" height="30" alt="team-logo"></span> <span>Brasil Industrial</span>', '<span ><img src="../images/soccer/aguabranca.png" width="30" height="30" alt="team-logo"></span> <span>Agua Branca</span>'],
                    //['<span ><img src="../images/soccer/setima.png" width="30" height="30" alt="team-logo"></span> <span>Setima</span>', '<span ><img src="../images/soccer/amazonas.png" width="30" height="30" alt="team-logo"></span> <span>Amazonas</span>'],
                    //['<span ><img src="../images/soccer/eldorado.png" width="30" height="30" alt="team-logo"></span> <span>Eldorado</span>', '<span ><img src="../images/soccer/quinta.png" width="30" height="30" alt="team-logo"></span> <span>Quinta</span>']
                ],
                results: [
                    //[[5, 2], [3, 4], [3, 5], [3, 2]],
                    //[[5,2], [5,4]],
        ...
        if ($('#final').length > 0) {
            ...
            $('#final').teamStandings({
                teams: [
                //    ['<span ><img src="../images/soccer/petrolandia.png" width="30" height="30" alt="team-logo"></span> <span>Petrolandia</span>', '<span ><img src="../images/soccer/aguabranca.png" width="30" height="30" alt="team-logo"></span> <span>Agua Branca</span>'],
                //    ['<span ><img src="../images/soccer/amazonas.png" width="30" height="30" alt="team-logo"></span> <span>Amazonas</span>', '<span ><img src="../images/soccer/eldorado.png" width="30" height="30" alt="team-logo"></span> <span>Eldorado</span>']
                ],
                results: [
                    //[[5, 2], [5, 4]],
                    //[[, ]]
